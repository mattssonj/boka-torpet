...
export default function ChangeUserInformationForm({show, hideFunction}) {
    ...
    return (
        <Modal show={show} onHide={hideFunction}>
            <Modal.Header><Modal.Title>Mina kontaktuppgifter</Modal.Title></Modal.Header>
            <Modal.Body>
                <Form>
                    <Form.Text className="text-muted">
                        Denna informationen kan ses när du skapat en bokning för att personer som undrar något ska kunna
                        kontakta dig.
                    </Form.Text>
            ...
            <Modal.Footer>
                ...
                <Button variant="primary" onClick={!isSaving ? saveInformation : null}
                        disabled={isSaving}>{isSaving ? 'Sparar...' : 'Spara'}</Button>
            </Modal.Footer>
        </Modal>
    );
}