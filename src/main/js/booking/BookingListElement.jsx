    ...
    <Card border="success">
      ...
      <Card.Body>
        ...
        <Row className="align-items-center">
          <Col>
            <Card.Text>
              Bokare: <b>{props.booking.booker}</b>
            </Card.Text>
          </Col>
          <Col>
            {props.booking.booker === props.username ? (
              <EditBookingButton booking={props.booking} />
            ) : null}
          </Col>
          <Col>
      ...
      <Card.Footer className="text-center text-muted">
        {props.booking.startDate} till {props.booking.endDate}
      </Card.Footer>
    </Card>
  );
}
