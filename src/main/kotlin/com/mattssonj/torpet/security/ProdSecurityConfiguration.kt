...
class ProdSecurityConfiguration(private val datasource: DataSource) : WebSecurityConfigurerAdapter() {

    override fun configure(http: HttpSecurity) {
        http
            .requiresChannel().anyRequest().requiresSecure() // This forces all requests to be made on https, this should not be used during development
            .and()
            .authorizeRequests()
